...
<img src="Transformers.assets/1547024562961.png" alt="img" style="zoom:67%;" />
...
<img src="Transformers.assets/1547024563097.png" alt="img" style="zoom:67%;" />
...
##### 计算自注意力的**第一步**就是从每个编码器的输入向量（每个单词的词向量）中生成三个向量。
